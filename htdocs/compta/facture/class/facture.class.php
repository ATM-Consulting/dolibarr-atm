...
class Facture extends CommonInvoice
{
	...
	public function update(User $user, $notrigger = 0)
	{
		...
		$sql .= " situation_counter=".(isset($this->situation_counter) ? $this->db->escape($this->situation_counter) : "null").",";	// InfraS change
	...
	{
		// phpcs:enable
		global $langs, $user;	// InfraS change
	...
	public function addline(
		...
		if ($this->statut == self::STATUS_DRAFT) {
			...
			$noerrorifdiscountalreadylinked = !empty($this->situation_cycle_ref) ? 1 : 0;	// InfraS add
			$result = $this->line->insert(0, $noerrorifdiscountalreadylinked);	// InfraS change
			if ($result > 0) {
