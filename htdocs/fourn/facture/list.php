...
$sql.= " f.rowid as facid, f.ref, f.ref_supplier, f.datef, f.date_lim_reglement as datelimite, f.fk_mode_reglement, s2.rowid as socid2, s2.nom as name2,";
...
if (!$search_all) {
	...
	$sql .= ' country.code,';
	$sql .= " p.rowid, p.ref, s2.rowid, p.title,";
