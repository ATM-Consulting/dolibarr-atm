...
class FactureFournisseur extends CommonInvoice
{
    ...
    */
    ...
    public function create($user)
    {
		...
		$error=0;
        $now=dol_now();
		$this->status = $this->statut = $this->fk_statut = self::STATUS_DRAFT;
        ...
        */
        ...
        $sql .= ", fk_fac_rec_source";  //BACKPORT - 10/01/2022 - Template supplier invoice
        $sql.= ")";
        $sql.= " VALUES (";
		$sql.= "'(PROV)'";
        ...
        $sql .= ", ".(isset($this->fk_fac_rec_source) ? $this->fk_fac_rec_source : "NULL"); //BACKPORT - 10/01/2022 - Template supplier invoice
        $sql.= ")";
    ...
    public function fetch($id = '', $ref = '')
    {
        ...
        $sql .= " t.fk_fac_rec_source,";     //BACKPORT - 10/01/2022 - Template supplier invoice
        ...
        if ($resql)
        {
            if ($this->db->num_rows($resql))
            {
                ...
                $this->fk_fac_rec_source	= $obj->fk_fac_rec_source;   //BACKPORT - 10/01/2022 - Template supplier invoice
