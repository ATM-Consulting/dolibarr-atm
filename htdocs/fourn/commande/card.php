...
if ($action == 'create')
{
	...
	$doleditor = new DolEditor('note_public', isset($note_public) ? $note_public : GETPOST('note_public', 'restricthtml'), '', 80, 'dolibarr_notes', 'In', 0, true, true, ROWS_3, '90%');
	...
	print '<td>';
	// Spé Kreos : add ability to add image in notes on proposal creation like in notes tab edition mod
	$doleditor = new DolEditor('note_private', isset($note_private) ? $note_private : GETPOST('note_private', 'restricthtml'), '', 80, 'dolibarr_notes', 'In', 0, true, true, ROWS_3, '90%');
	print $doleditor->Create(1);
	print '</td>';
