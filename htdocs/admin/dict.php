...
if (GETPOST('actionadd') || GETPOST('actionmodify'))
{
    ...
    if ($ok && GETPOST('actionadd'))
    {
        ...
        foreach ($listfieldinsert as $f => $value)
        {
            ...
            elseif ($value == 'entity') {
                $listfieldvalue[$i] = getEntity($tabname[$id]);
            }
            if ($i) $sql .= ",";
            ...
            elseif ($listfieldvalue[$i] == '' && !($listfieldvalue[$i] == 'code' && $id == 10)) $sql .= "null"; // For vat, we want/accept code = ''
            elseif ($value == 'entity') 
                $sql .= "'".$db->escape($listfieldvalue[$i])."'";
