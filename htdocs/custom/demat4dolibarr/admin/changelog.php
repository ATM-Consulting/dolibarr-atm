...
/**
 *	    \file       htdocs/demat4dolibarr/admin/about.php
 *		\ingroup    demat4dolibarr
 *		\brief      Page about of demat4dolibarr module
 */
...
dol_fiche_head($head, 'changelog', $langs->trans("Module163028Name"), 0, 'opendsi@demat4dolibarr');

$changelog = opendsi_common_getChangeLog('demat4dolibarr');
