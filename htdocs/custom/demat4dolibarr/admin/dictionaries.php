...
/**
 *	    \file       htdocs/demat4dolibarr/admin/dictionaries.php
 *		\ingroup    demat4dolibarr
 *		\brief      Page dictionaries of demat4dolibarr module
 */
...
dol_include_once('/demat4dolibarr/lib/opendsi_common.lib.php');
...
dol_fiche_head($head, 'dictionaries', $langs->trans("Module163028Name"), 0, 'opendsi@demat4dolibarr');

$moduleFilter = ''; // array or string to set the dictionaries of witch modules to show in dictionaries list
$familyFilter = 'demat4dolibarr'; // array or string to set the dictionaries of witch family to show in dictionaries list
