...
/**
 * \file        core/dictionaries/demat4dolibarrbillingmode.dictionary.php
 * \ingroup     demat4dolibarr
 * \brief       Class of the dictionary Billing Mode
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Demat4DolibarrBillingModeDictionary
 */
class Demat4DolibarrBillingModeDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'Demat4DolibarrBillingModeDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_demat4dolibarr_billing_mode';
