...
/**
 * \file        core/dictionaries/demat4dolibarrvalidatortypeid.dictionary.php
 * \ingroup     demat4dolibarr
 * \brief       Class of the dictionary Validator Type Id
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Demat4DolibarrValidatorTypeIdDictionary
 */
class Demat4DolibarrValidatorTypeIdDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'Demat4DolibarrValidatorTypeIdDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_demat4dolibarr_validator_type_id';
