...
/**
 * \file        core/dictionaries/demat4dolibarrjobstatus.dictionary.php
 * \ingroup     demat4dolibarr
 * \brief       Class of the dictionary Job Status
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Demat4DolibarrJobStatusDictionary
 */
class Demat4DolibarrJobStatusDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'Demat4DolibarrJobStatusDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_demat4dolibarr_job_status';
