...
/**
 * \file        core/dictionaries/demat4dolibarrinvoicestatus.dictionary.php
 * \ingroup     demat4dolibarr
 * \brief       Class of the dictionary Invoice Status
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Demat4DolibarrInvoiceStatusDictionary
 */
class Demat4DolibarrInvoiceStatusDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'Demat4DolibarrInvoiceStatusDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_demat4dolibarr_invoice_status';
    ...
    public $fields = array(
        ...
        'can_resend' => array(
            'name'       => 'can_resend',
            'label'      => 'Demat4DolibarrNewSendPossible',
            'type'       => 'boolean',
        ),
    );
