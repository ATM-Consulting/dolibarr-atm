...
/**
 * \file        core/dictionaries/demat4dolibarrpaymentcode.dictionary.php
 * \ingroup     demat4dolibarr
 * \brief       Class of the dictionary Payment Code
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Demat4DolibarrPaymentCodeDictionary
 */
class Demat4DolibarrPaymentCodeDictionary extends Dictionary
{
    /**
     ...
     */
    public $langs = array('demat4dolibarr@demat4dolibarr');
     ...
     */
    public $familyLabel = 'Module163028Name';
	...
	protected function initialize()
	{
		...
		$langs->loadLangs(array('bills', 'demat4dolibarr@demat4dolibarr'));
        ...
        foreach ($form->cache_types_paiements as $type_paiement) {
            if ($type_paiement['id'] > 0)
                $mode_reglement[$type_paiement['id']] = $type_paiement['label'];
        }
		...
		$this->fields['payment_code'] = array(
			'name' => 'payment_code',
			'label' => 'Demat4DolibarrPaymentCode',
			'type' => 'select',
			'options' => [
				'01' => $langs->trans('Demat4DolibarrPaymentCodeInstrumentNotDefined'),
				'10' => $langs->trans('Demat4DolibarrPaymentCodeCash'),
				'20' => $langs->trans('Demat4DolibarrPaymentCodeCheck'),
				'30' => $langs->trans('Demat4DolibarrPaymentCodeCreditTransfert'),
				'31' => $langs->trans('Demat4DolibarrPaymentCodeDebitTransfert'),
				'42' => $langs->trans('Demat4DolibarrPaymentCodePaymentToBankAccount'),
				'48' => $langs->trans('Demat4DolibarrPaymentCodeBankCard'),
				'49' => $langs->trans('Demat4DolibarrPaymentCodeDirectDebit'),
				'97' => $langs->trans('Demat4DolibarrPaymentCodeClearingBetweenPartners'),
			],
			'is_require' => true,
		);
	}
