...
/**
 * \file        core/dictionaries/demat4dolibarrchorusstatus.dictionary.php
 * \ingroup     demat4dolibarr
 * \brief       Class of the dictionary Chorus Status
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Demat4DolibarrChorusStatusDictionary
 */
class Demat4DolibarrChorusStatusDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'Demat4DolibarrChorusStatusDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_demat4dolibarr_chorus_status';
