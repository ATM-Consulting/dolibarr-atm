...
$arrayfields = array(
	...
	*/
	...
	'p.tosell'=>array('label'=>$langs->transnoentitiesnoconv("Status").' ('.$langs->trans("Sell").')', 'checked'=>1, 'position'=>1000),
	'p.tobuy'=>array('label'=>$langs->transnoentitiesnoconv("Status").' ('.$langs->trans("Buy").')', 'checked'=>1, 'position'=>1000)
);
...
$sql = 'SELECT DISTINCT p.rowid, p.ref, p.label, p.fk_product_type, p.price, p.entity,';
/*
$sql .= ' p.barcode,';
$sql .= ' p.tva_tx, p.price_ttc, p.price_base_type,';
$sql .= ' p.fk_product_type, p.duration, p.finished,';
*/
$sql .= ' p.tosell, p.tobuy, p.stock, p.tms as date_update';
/*
$sql .= ' p.seuil_stock_alerte, p.desiredstock,';
$sql .= ' p.tobatch,';
$sql .= ' p.accountancy_code_sell, p.accountancy_code_sell_intra, p.accountancy_code_sell_export,';
$sql .= ' p.accountancy_code_buy, p.accountancy_code_buy_intra, p.accountancy_code_buy_export,';
$sql .= ' p.datec as date_creation,  p.pmp, ';
...
$sql .= $hookmanager->resPrint;
$sql .= " GROUP BY p.rowid, p.ref, p.label, p.price, p.fk_product_type, p.entity, p.tosell, p.tobuy, p.tms";
/* 
$sql .= " ,p.barcode,";
$sql .= " p.tva_tx, p.price_ttc, p.price_base_type, ";
$sql .= " p.duration, p.finished,  p.seuil_stock_alerte, p.desiredstock,";
$sql .= ' p.datec, p.tobatch,';
$sql .= ' p.accountancy_code_sell, p.accountancy_code_sell_intra, p.accountancy_code_sell_export,';
$sql .= ' p.accountancy_code_buy, p.accountancy_code_buy_intra, p.accountancy_code_buy_export,';
$sql .= ' p.pmp, p.stock, p.weight, p.weight_units, p.length, p.length_units, p.width, p.width_units, p.height, p.height_units, p.surface, p.surface_units, p.volume, p.volume_units';
