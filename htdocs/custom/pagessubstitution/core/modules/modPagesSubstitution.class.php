...
/**
 * 	\defgroup   pagessubstitution     Module Pages Substitution
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/pagessubstitution/core/modules directory.
 *  \file       htdocs/pagessubstitution/core/modules/modPagesSubstitution.class.php
 *  \ingroup    pagessubstitution
 *  \brief      Description and activation file for module Pages Substitution
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Pages Substitution
 */
class modPagesSubstitution extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 163009;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'pagessubstitution';
		...
		$this->description = "Description of module Pages Substitution";
		$this->descriptionlong = "";
		$this->editor_name = 'Open-DSI';
		$this->editor_url = 'http://www.open-dsi.fr';
		
		// Possible values for version are: 'development', 'experimental', 'dolibarr', 'dolibarr_deprecated' or a version string like 'x.y.z'
		$this->version = '4.0.3b Eurochef 25-02-2022';
		...
		$this->config_page_url = array("setup.php@pagessubstitution");
		...
		$this->langfiles = array("pagessubstitution@pagessubstitution", "opendsi@pagessubstitution");
		...
		// );
		$this->const = array(
            0=>array('PAGESSUBSTITUTION_HOOK_TEST','chaine','0','Affiche les pages supportées.',0, 'current')
        );
		...
		if (! isset($conf->pagessubstitution) || ! isset($conf->pagessubstitution->enabled))
        {
        	$conf->pagessubstitution=new stdClass();
        	$conf->pagessubstitution->enabled=0;
        }
