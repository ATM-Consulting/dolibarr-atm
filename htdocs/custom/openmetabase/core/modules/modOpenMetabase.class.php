...
/**
 * 	\defgroup   openmetabase     Module OpenMetabase
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/openmetabase/core/modules directory.
 *  \file       htdocs/openmetabase/core/modules/modOpenMetabase.class.php
 *  \ingroup    openmetabase
 *  \brief      Description and activation file for module OpenMetabase
 */
...
/**
 *  Description and activation class for module OpenMetabase
 */
class modOpenMetabase extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
        ...
        $this->db = $db;
        $langs->load('opendsi@openmetabase');

		// Id for module (must be unique).
		// Use here a free id (See in Home -> System information -> Dolibarr for list of used modules id).
		$this->numero = 163052;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'openmetabase';
		...
		$this->config_page_url = array("setup.php@openmetabase");
		...
		if (! isset($conf->openmetabase) || ! isset($conf->openmetabase->enabled))
        {
        	$conf->openmetabase=new stdClass();
        	$conf->openmetabase->enabled=0;
        }
        ...
        */
		...
		// Cronjobs
		$this->cronjobs = array(
		    0 => array('label'=>$langs->trans("OpenMetabaseSendDatabaseCron"), 'jobtype'=>'method', 'class'=>'/openmetabase/class/openmetabase.class.php', 'objectname'=>'OpenMetabase', 'method'=>'cronSendDatabaseToOpenMetabase', 'parameters'=>'', 'comment'=>'', 'frequency'=>1, 'unitfrequency'=>86400, 'test'=>true),
	...
	public function init($options='')
	{
        ...
        $this->_load_tables('/openmetabase/sql/');
