...
/**
 * \file        core/dictionaries/banking4dolibarrbankaccounttypes.dictionary.php
 * \ingroup     banking4dolibarr
 * \brief       Class of the dictionary Bank Account Types
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for Banking4DolibarrBankAccountTypesDictionary
 */
class Banking4DolibarrBankAccountTypesDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'Banking4DolibarrBankAccountTypesDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_banking4dolibarr_bank_account_type';
    ...
    public $fields = array(
        'label' => array(
            ...
            'show_input' => array(
                'moreAttributes' => ' style="width:50%;"',
            ),
            'is_not_editable' => true,
        ),
        'type_of_bank_account' => array(),
        'datas' => array(
            'name'                      => 'datas',
	...
	protected function initialize()
	{
		...
		$this->fields['type_of_bank_account'] = array(
...
/**
 * Class for Banking4DolibarrBankAccountTypesDictionaryLine
 */
class Banking4DolibarrBankAccountTypesDictionaryLine extends DictionaryLine
{
}