<?php
	...
	************************************************/
	class pdf_InfraSPlus_DST extends ModelePDFPropales
	{
		public $db;
		public $name;
		public $description;
		...
		********************************************/
		public function __construct($db)
		{
			...
			$this->name							= $langs->trans('PDFInfraSPlusProposalStName');
			$this->description					= $langs->trans('PDFInfraSPlusProposalStDescription');
			...
			$this->show_sign_area				= isset($conf->global->INFRASPLUS_PDF_PROPAL_ST_SHOW_SIGNATURE)	? $conf->global->INFRASPLUS_PDF_PROPAL_ST_SHOW_SIGNATURE	: 0;
		...
		********************************************/
		public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
		{
			...
			$filesufixe						= ! $this->multi_files || ($this->defaulttemplate && $this->defaulttemplate == 'InfraSPlus_DST') ? '' : '_DST';
			...
			if ($baseDir) {
				...
				if (file_exists($dir)) {
					...
					if (!empty($this->hide_totcol))									$this->larg_totalht		= 0;
		...
		********************************************/
		protected function _tableau_info(&$pdf, $object, $posy, $outputlangs, $calculseul = 0)
		{
			...
			if (empty($this->hide_pay_term_mode)) {
				...
				if (empty($object->mode_reglement_code) || $object->mode_reglement_code == 'VIR' || ($object->mode_reglement_code == 'CB' && $this->IBAN_with_CB)) {
