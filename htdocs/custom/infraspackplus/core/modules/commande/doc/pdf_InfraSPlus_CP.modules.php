<?php
	...
	************************************************/
	...
	/************************************************
	* 	\file		../infraspackplus/core/modules/commande/doc/pdf_InfraSPlus_CP.modules.php
	* 	\ingroup	InfraS
	...
	class pdf_InfraSPlus_CP extends ModelePDFCommandes
	{
		...
		********************************************/
		public function __construct($db)
		{
			...
			$this->name							= $langs->trans('PDFInfraSPlusProformaName');
			$this->description					= $langs->trans('PDFInfraSPlusProformaDescription');
		...
		********************************************/
		public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
		{
			...
			$filesufixe						= ! $this->multi_files || ($this->defaulttemplate && $this->defaulttemplate == 'InfraSPlus_CP') ? '' : '_CP';
			...
			if ($baseDir) {
				...
				if (file_exists($dir)) {
					...
					$pdf->SetSubject($outputlangs->transnoentities('InvoiceProForma'));
					$pdf->SetCreator("Dolibarr ".DOL_VERSION);
					$pdf->SetAuthor($outputlangs->convToOutputCharset($user->getFullName($outputlangs)));
					$pdf->SetKeyWords($outputlangs->convToOutputCharset($object->ref).' '.$outputlangs->transnoentities('InvoiceProForma').' '.$outputlangs->convToOutputCharset($object->thirdparty->name));
