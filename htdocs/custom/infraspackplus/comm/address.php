...
if ($action == 'add' || $action == 'update')
{
    ...
    $object->email		= $_POST["email"]; // InfraS add
    $object->url		= $_POST["url"]; // InfraS add
...
if ($action == 'create')
{
    if ($user->rights->societe->creer)
    {
        ...
        print '<tr><td class="fieldrequired">'.$langs->trans('InfraSPlusParamAdressAlias').'</td><td><input type="text" size="30" name="label" id="label" value="'.($object->label?$object->label:$langs->trans('RequiredField')).'"></td></tr>';
        ...
        print '<tr><td>'.$langs->trans('Email').'</td><td><input type="text" name="email" value="'.$object->email.'"></td></tr>'; // InfraS add

        print '<tr><td>'.$langs->trans('url').'</td><td><input type="text" name="url" value="'.$object->url.'"></td></tr>'; // InfraS add
...
elseif ($action == 'edit')
{
    ...
    if ($socid)
    {
        ...
        print '<tr><td>'.$langs->trans('InfraSPlusParamAdressAlias').'</td><td colspan="3"><input type="text" size="40" name="label" value="'.$object->label.'"></td></tr>';
...
else
{
    ...
    if ($nblines)
    {
        for ($i = 0 ; $i < $nblines ; $i++)
        {
            ...
            print '<tr><td width="20%">'.$langs->trans('InfraSPlusParamAdressAlias').'</td><td colspan="3">'.$object->lines[$i]->label.'</td>';
            ...
            print '<tr><td>'.$langs->trans('Email').'</td><td>'.$object->lines[$i]->email.'</td></tr>'; // InfraS add

            print '<tr><td>'.$langs->trans('url').'</td><td>'.$object->lines[$i]->url.'</td></tr>'; // InfraS add
