...
/**
 * 	\defgroup   eurocheflangue     Module eurocheflangue
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/eurocheflangue/core/modules directory.
 *  \file       htdocs/eurocheflangue/core/modules/modeurocheflangue.class.php
 *  \ingroup    eurocheflangue
 *  \brief      Description and activation file for module eurocheflangue
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module eurocheflangue
 */
class modeurocheflangue extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
        ...
        $this->db = $db;
        $langs->load('opendsi@eurocheflangue');

		// Id for module (must be unique).
		// Use here a free id (See in Home -> System information -> Dolibarr for list of used modules id).
		$this->numero = 501000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'eurocheflangue';
		...
		$this->description = "Module spécifique pour eurocheflangue.";
		...
		$this->picto='opendsi_big@eurocheflangue';
		...
		//                        	'tpl' => 0,                                      	// Set this to 1 if module overwrite tmplate dir (core/tpl)
		...
		$this->config_page_url = array("setup.php@eurocheflangue");
		...
		$this->langfiles = array("eurocheflangue@eurocheflangue", "opendsi@eurocheflangue");
        $langs->load('eurocheflangue@eurocheflangue');
		...
		// );
        $this->const = array(
            0 => array('MAIN_FORCELANGDIR','chaine','/custom/eurocheflangue/','',1,'current',0),
        );
		...
		if (! isset($conf->eurocheflangue) || ! isset($conf->eurocheflangue->enabled))
        {
        	$conf->eurocheflangue=new stdClass();
        	$conf->eurocheflangue->enabled=0;
        }
	...
	public function init($options='')
	{
        ...
        //$this->_load_tables('/eurocheflangue/sql/');
