...
/**
 *	\file       contactcommande/contactcommandeindex.php
 *	\ingroup    contactcommande
 *	\brief      Home page of contactcommande top menu
 */
...
$langs->loadLangs(array("contactcommande@contactcommande"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->contactcommande->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("ContactCommandeArea"));

print load_fiche_titre($langs->trans("ContactCommandeArea"), '', 'contactcommande.png@contactcommande');
...
// Draft MyObject
if (! empty($conf->contactcommande->enabled) && $user->rights->contactcommande->read)
{
	$langs->load("orders");
