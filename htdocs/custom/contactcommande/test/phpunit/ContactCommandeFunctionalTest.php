...
/**
 * \file    test/phpunit/ContactCommandeFunctionalTest.php
...
/**
 * Class ContactCommandeFunctionalTest
 *
 ...
 *
 * @package Testcontactcommande
 */
class ContactCommandeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modContactCommande')->click();
		} else {
			// Disable the module
			$this->byHref('modContactCommande')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/contactcommande/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('contactcommande/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/contactcommande/admin/about.php');
		$this->authenticate();
		return $this->assertContains('contactcommande/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('contactcommandewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modContactCommande_ContactCommandeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modContactCommande_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
