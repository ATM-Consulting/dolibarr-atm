...
/**
 * \file    test/phpunit/EvenementChaineInfoFunctionalTest.php
...
/**
 * Class EvenementChaineInfoFunctionalTest
 *
 ...
 *
 * @package Testevenementchaineinfo
 */
class EvenementChaineInfoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEvenementChaineInfo')->click();
		} else {
			// Disable the module
			$this->byHref('modEvenementChaineInfo')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/evenementchaineinfo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('evenementchaineinfo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/evenementchaineinfo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('evenementchaineinfo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('evenementchaineinfowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEvenementChaineInfo_EvenementChaineInfoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEvenementChaineInfo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
