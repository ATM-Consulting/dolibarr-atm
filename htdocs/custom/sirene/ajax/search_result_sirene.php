...
$company_infos = array(
	...
	'staff_label'          => GETPOST('sirene_staff_label', 'alpha'),
    'staff'                => GETPOST('sirene_staff', 'alpha'),
	'legalcategory_id'     => GETPOST('sirene_legalcategory_id', 'alpha'),
	'legalcategory'        => GETPOST('sirene_legalcategory', 'alpha'),
...
if ($socid > 0 && !empty($company_infos['siret'])) {
	...
	$correspondance = array(
		'company_name'         => array('title'  => $langs->trans("SireneCompanyName"), 'dolibarr' => $societe->name,
										'sirene' => $company_infos['company_name']),
		'address'              => array('title'  => $langs->trans("Address"), 'dolibarr' => $societe->address,
										'sirene' => $company_infos['address']),
		'zipcode'              => array('title'  => $langs->trans("CompanyZip"), 'dolibarr' => $societe->zip,
										'sirene' => $company_infos['zipcode']),
		'town'                 => array('title'  => $langs->trans("SireneTown"), 'dolibarr' => $societe->town,
										'sirene' => $company_infos['town']),
		'siren'                => array('title'  => $langs->trans("SireneSiren"), 'dolibarr' => $societe->idprof1,
										'sirene' => $company_infos['siren']),
		'siret'                => array('title'  => $langs->trans("SireneSiret"), 'dolibarr' => $societe->idprof2,
										'sirene' => $company_infos['siret']),
		'codenaf_san'          => array('title'  => $langs->trans("SireneNaf"), 'dolibarr' => $societe->idprof3,
										'sirene' => $company_infos['codenaf_san']),
		'sirene_tva_intra'     => array('title'  => $langs->trans("SireneTvaIntra"), 'dolibarr' => $societe->tva_intra,
										'sirene' => $company_infos['sirene_tva_intra']),
		'country'              => array('title'  => $langs->trans("SireneCountry"), 'dolibarr' => $societe->country,
										'sirene' => $company_infos['country']),
		'country_id'           => array('title'  => $langs->trans("SireneCountryISO"), 'dolibarr' => $societe->country_id,
                                        'sirene' => $company_infos['country_id']),
        // Effectif
		'staff_label'          => array('title'  => $langs->trans("SireneStaff"), 'dolibarr' => $societe->effectif,
										'sirene' => $company_infos['staff_label']),
//        'staff'                => array('title'  => $langs->trans("SireneStaff"), 'dolibarr' => $societe->effectif_id,
//                                        'sirene' => $company_infos['staff_id']),
        // Type entité légale
		'legalcategory_id'     => array('title'    => $langs->trans("SireneJuridicalStatusLevel2"), 'dolibarr' => $societe->forme_juridique,
										'sirene'   => $company_infos['legalcategory_id']),
//		'legalcategory'        => array('title'    => $langs->trans("SireneJuridicalStatusLevel2"), 'dolibarr' => $societe->forme_juridique_code,
//										'sirene'   => $company_infos['legalcategory_id']),
	);
