...
function checkMultiCompanyVersion()
{
	...
	if (empty($conf->global->MULTICOMPANY_MAIN_VERSION) || (version_compare($dolversion[0], '14', '=') && version_compare($conf->global->MULTICOMPANY_MAIN_VERSION, '14.0.0', '<'))) {
		$out = -2;
	} else {
		$out = version_compare($dolversion[0], '14');
	}
