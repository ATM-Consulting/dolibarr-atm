...
/**
 * 	\defgroup   eurochefintervention     Module EurochefIntervention
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/eurochefintervention/core/modules directory.
 *  \file       htdocs/eurochefintervention/core/modules/modEurochefIntervention.class.php
 *  \ingroup    eurochefintervention
 *  \brief      Description and activation file for module EurochefIntervention
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module EurochefIntervention
 */
class modEurochefIntervention extends DolibarrModules
{
    var $extrafields;
	...
	public function __construct($db)
	{
		...
		$this->numero = 163058;        // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'eurochefintervention';
		...
		$this->description = "Description of module EurochefIntervention";
        ...
        $this->config_page_url = array('setup.php@eurochefintervention');
		...
		$this->langfiles = array("eurochefintervention@eurochefintervention", "opendsi@eurochefintervention");
		...
		if (!isset($conf->eurochefintervention) || !isset($conf->eurochefintervention->enabled)) {
			$conf->eurochefintervention = new stdClass();
			$conf->eurochefintervention->enabled = 0;
		}
	...
	public function init($options='')
	{
		...
		//$this->_load_tables('/eurochefintervention/sql/');
