		...
		if ($action == 'delete') {
            ...
            $formquestion = [
                [
                    'type' => 'date',
                    'name' => 'd_start',
                    'label' => $langs->trans('DateServiceActivate'),
                    /*'value' => $form->selectDate('', '', $usehm, $usehm, '', "active", 1, 0),*/
                    /*'socid', '(s.client=1 OR s.client=2 OR s.client=3)'*/
                ],
                [
                    'type' => 'date',
                    'name' => 'd_end',
                    'label' => $langs->trans('DateEndPlanned'), /*'value' => $form->selectDate('', "end", $usehm, $usehm, '', "active", 1, 0),*/
                    '',
                    ''
                ],
                ['type' => 'text', 'name' => 'comment', 'label' => $langs->trans('Comment'), 'value' => '', '', '', 'class' => 'minwidth300']
            ];
