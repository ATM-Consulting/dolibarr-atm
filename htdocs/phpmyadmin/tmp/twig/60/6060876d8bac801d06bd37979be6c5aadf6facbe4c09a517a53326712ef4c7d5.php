...
class __TwigTemplate_290be3a042f637fa59759ae933dc4d802487dac767fae5ed86f12fae8b920b4c extends Template
{
    private $source;
    private $macros = [];
...
$context["row"], "result_count", [], "any", false, false, false, 14)));
            ...
            ";
            // line 20
            if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["row"], "result_count", [], "any", false, false, false, 20), 0))) {
                // line 21
                echo "                ";
...
";
        // line 54
        if ((1 === twig_compare(twig_length_filter($this->env, ($context["criteria_tables"] ?? null)), 1))) {
            // line 55
            echo "    <p>
        ";
...
";
    ...
    {
        return new Source("", "database/search/results.twig", "/home/groupe-cara/domains/mycara.groupe-cara.fr/public_html/htdocs/phpmyadmin/templates/database/search/results.twig");
    }
}
