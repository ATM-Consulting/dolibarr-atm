...
class __TwigTemplate_554515156f50053ee1e2d5a04a628acc168796015aef8f43e8b272a05f3f1b2f extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Description");
      ...
      <tbody>
        ...
        foreach ($context['_seq'] as $context["engine"] => $context["details"]) {
            ...
            echo "          <tr class=\"";
            // line 20
            echo ((((0 === twig_compare((($__internal_compile_0 = $context["details"]) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["Support"] ?? null) : null), "NO")) || (0 === twig_compare((($__internal_compile_1 = $context["details"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["Support"] ?? null) : null), "DISABLED")))) ? (" disabled") : (""));
            echo "
            ";
            // line 21
            echo (((0 === twig_compare((($__internal_compile_2 = $context["details"]) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["Support"] ?? null) : null), "DEFAULT"))) ? (" marked") : (""));
            echo "\">
            <td>
              <a rel=\"newpage\" href=\"";
            // line 23
...
";
    ...
    {
        return new Source("", "server/engines/index.twig", "/home/groupe-cara/domains/mycara.groupe-cara.fr/public_html/htdocs/phpmyadmin/templates/server/engines/index.twig");
    }
}
