...
//         	// Divisez le label en deux parties en utilisant le dernier espace (nom complet et numéro)
// 			list($full_name, $invoice_number) = explode(' ', $data->label_operation, 2);

// 			// Divisez le nom complet en segments basés sur l'espace
// 			$segments = explode(' ', $full_name);

// 			// Si le nom contient au moins deux segments, concaténez les deux premiers
// 			$shortened_name = (count($segments) >= 2) ? $segments[0] . ' ' . $segments[1] : $full_name;

// 			// Concaténez le nom raccourci et le numéro de facture
// 			$data->label_operation = $shortened_name . ' ' . $invoice_number;
        
//         	$data->doc_ref = iconv('UTF-8', 'ASCII//TRANSLIT', $data->doc_ref);
// 			$data->label_operation = iconv('UTF-8', 'ASCII//TRANSLIT', $data->label_operation);
// 			$data->numero_compte = iconv('UTF-8', 'ASCII//TRANSLIT', $data->numero_compte);
// 			$data->label_compte = iconv('UTF-8', 'ASCII//TRANSLIT', $data->label_compte);
// 			$data->subledger_account = iconv('UTF-8', 'ASCII//TRANSLIT', $data->subledger_account);
// 			$data->subledger_label = iconv('UTF-8', 'ASCII//TRANSLIT', $data->subledger_label);
