...
class modAgenda extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Backport de l'import evenement spe pour le meleze (v19 #27184)
		$r++;
		...
		$this->export_TypeFields_array[$r] = [
			...
			'ac.percent' => "Numeric",
			'ac.durationp' => "Duree",
			'ac.fk_user_author' => 'Numeric',
			'ac.fk_user_action' => 'Numeric',
			'ac.fk_user_mod' => 'Numeric',
			'ac.transparency' => "Numeric",
			'ac.priority' => "Numeric",
			'ac.fk_element' => "Numeric",
			'ac.elementtype' => "Text",
		...
		$this->export_entities_array[$r] = [
			...
			'ac.percent' => "action",
			'ac.durationp' => "action",
			'ac.fk_user_author' => 'user',
			'ac.fk_user_action' => 'user',
			'ac.fk_user_mod' => 'user',
			'ac.transparency' => "action",
			'ac.priority' => "action",
			'ac.fk_element' => "action",
			'ac.elementtype' => "action",
			's.rowid' => "company",
			's.nom' => 'company',
			's.address' => 'company',
			's.zip' => 'company',
